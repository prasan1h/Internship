...
function updatePhotosNextButton() {
  ...
  console.log("Photo uploaded:", hasImage !== null);
  console.log("Reg number filled:", hasRegNumber);
  ...
  if (hasImage && hasRegNumber) {
    ...
    photosNextBtn.className = "px-8 py-3 bg-secondary text-white font-semibold rounded-md hover:bg-blue-700 transition-all";
  } else {
